from network_keras import keras_network,_objective
import numpy as np
...
def train_network(X_train,
    ...
    for i in range(EPOCH):
        ...
        model.backwards_de(X_train, y_train)

        loss = np.mean(_objective(model.predict(X_test),y_test))
...
if __name__ == '__main__':
    ...
    nn = keras_network(bias=True, pop_size=POP_SIZE,
    ...
    X_train, y_train, X_test, y_test, sc_y = \
        dataset_norm_scale('mpp_dataset_v1_13-inputs.xls')
